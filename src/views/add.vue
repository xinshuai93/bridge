...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      // this.$refs[this.form1].validate((valid) => {
      //   if (valid) {
      //     axios.post('http://localhost:8183/normal_info/save',this.form1).then(function(resp){
      //         if(resp.data == 'success')
      //         {
      //             _this.$message('添加成功')
      //         }
...
this.onSubmit1(this.form)
      ...
      //   if (valid) {
      //     axios.post('http://localhost:8183/bridge_Information/save',this.form).then(function(resp){
      //         if(resp.data == 'success')
      //         {
      //             _this.$message('添加成功')
      //         }
